...
// Pre-compute grass data once at module load (never regenerated)
const GRASS_DATA = Array.from({ length: 50 }, (_, i) => ({
  left: `${i * 2.5}%`,
...
export const SimpleBackground = memo(() => {
  return (
        ...
        {GRASS_DATA.map((grass, i) => (
          <div
            ...
            style={{
              left: grass.left,
              height: grass.height,
              animationDelay: grass.animationDelay,
              animationDuration: grass.animationDuration,
            }}
          />
        ))}
      </div>
